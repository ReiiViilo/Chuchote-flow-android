...
Java_com_whispercpp_whisper_WhisperLib_00024Companion_fullTranscribe(
    ...
    // Décodage glouton plutôt que par faisceau : la recherche par faisceau
    // explore cinq hypothèses en parallèle, ce qui multiplie d'autant le temps
    // de décodage pour un gain de justesse marginal en dictée courte. Sur un
    // processeur de téléphone, c'est la différence entre une attente
    // acceptable et une attente qui décourage l'usage.
